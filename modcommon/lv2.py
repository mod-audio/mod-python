...
class Plugin(model.Model):
    ...
    url = model.NameField()
    name = model.StringField(LV2Def.doap.name)
    maintainer = model.InlineModelField(Foaf, LV2Def.doap.maintainer)
    developer = model.InlineModelField(Foaf, LV2Def.doap.developer)
    license = model.StringField(
